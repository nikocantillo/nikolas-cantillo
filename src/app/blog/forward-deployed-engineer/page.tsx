    ...
    <main className="mx-auto max-w-4xl px-6 py-12">
      ...
      <section className="space-y-4">
        ...
        <p className="text-muted-foreground leading-7">
          ...
          implementacion. En la practica, participa en conversaciones de producto, revisa procesos
          operativos, identifica restricciones tecnicas y construye una primera version funcional
          que ya genera valor.
        </p>
        <p className="text-muted-foreground leading-7">
      ...
      <section className="space-y-4 mt-10">
        ...
        <p className="text-muted-foreground leading-7">
          En muchos equipos, las soluciones fracasan no por falta de tecnologia, sino por falta de
          aterrizaje operacional. El FDE reduce ese riesgo porque trabaja desde el primer dia con
          restricciones reales: datos incompletos, procesos legacy, requerimientos regulatorios y
          tiempos de negocio exigentes.
        </p>
        <p className="text-muted-foreground leading-7">
          Tambien acelera el ciclo de aprendizaje: al estar cerca del usuario final, puede iterar
          mas rapido sobre decisiones clave y evitar meses de construccion en una direccion que no
          genera impacto.
        </p>
      </section>
      ...
      <section className="space-y-4 mt-10">
        ...
        <ul className="list-disc pl-6 text-muted-foreground space-y-2 leading-7">
          ...
          <li>
            <span className="font-medium text-foreground">Contexto de producto:</span> traducir
            objetivos de negocio en decisiones de diseno e implementacion.
          </li>
          <li>
          ...
          <li>
            <span className="font-medium text-foreground">Enfoque en produccion:</span> pensar en
            observabilidad, confiabilidad, seguridad y mantenimiento desde el inicio.
          </li>
        </ul>
      </section>
      ...
      <section className="space-y-4 mt-10">
        ...
        <p className="text-muted-foreground leading-7">
          En productos con LLMs y pipelines de datos, este rol es especialmente util porque conecta
          tres capas que rara vez se coordinan bien por separado: necesidad de negocio, calidad de
          datos y comportamiento real del sistema en produccion.
        </p>
        <p className="text-muted-foreground leading-7">
          Un FDE no solo pregunta si el modelo responde bien, tambien valida si la solucion se
          integra con el flujo operativo, si es auditable y si puede mantenerse cuando aumenten el
          volumen y la complejidad del uso.
        </p>
      </section>
      ...
      <section className="space-y-4">
        ...
        <p className="text-muted-foreground leading-7">
          El Forward Deployed Engineer es, en esencia, un constructor de impacto: alguien capaz de
          unir estrategia, implementacion y ejecucion real. En un contexto donde las empresas
          quieren llevar AI a produccion con resultados concretos, este perfil deja de ser un lujo
